...
<main class="combat">
	...
	<section class="panel rail right sidebar activity-sidebar">
		<RollLog bind:this={rollLog} campaignId={data.campaignId} dm initial={data.rolls} initialCombat={data.logs} />
	</section>
</main>
